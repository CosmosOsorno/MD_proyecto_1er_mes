...
df_plot = df[(df['densidad'] > 0) & (df['densidad'] <= 100)]
sc = plt.scatter(df_plot['pl_rade'], df_plot['pl_bmasse'], c=df_plot['densidad'],cmap='tab20b')
...
plt.scatter(1,1, label='Tierra', c='red')
plt.scatter(11.2,317.8, label='Júpiter', c='blue')
plt.scatter(3.8,17.2, label='Neptuno', c='cyan')
plt.legend()
